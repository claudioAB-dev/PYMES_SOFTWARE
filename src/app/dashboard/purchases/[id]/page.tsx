...
import { RegisterSupplierPaymentSheet } from "@/components/purchases/register-supplier-payment-sheet";
import { PurchaseOrderStatusActions } from "@/components/purchases/purchase-order-status-actions";
    ...
    return (
        <div className="space-y-6 p-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Orden de Compra #{order.id.slice(0, 8)}</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle>Historial de Pagos Emitidos</CardTitle>
                        </CardHeader>
                        <CardContent>
                            {order.payments.length === 0 ? (
                                <p className="text-muted-foreground text-sm">No hay pagos a proveedor registrados.</p>
                            ) : (
                                <Table>
                                    <TableHeader>
                                        <TableRow>
