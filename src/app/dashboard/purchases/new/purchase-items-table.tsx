...
export function PurchaseItemsTable({ form, products }: PurchaseItemsTableProps) {
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead className="w-[20%]">Precio Unitario (Costo)</TableHead>
                                                ...
                                                <FormControl>
                                                    <Select
                                                        onValueChange={(value) => {
                                                            ...
                                                            // Opcional: Para compras a lo mejor el costo no es el precio de venta.
                                                            // Pero como base podemos poner 0 o el precio actual.
...
function TotalCell({ index, form }: { index: number; form: UseFormReturn<CreatePurchaseOrderInput> }) {
